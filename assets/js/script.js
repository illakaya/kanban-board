...
function handleDrop(event, ui) {
    ...
    // For the object with the class draggable, extract the data 'task-id'.
    // Note: you need the attribute to have data-name for dataset to be able to read that attribute
